...
import { e as ensure404Route, d as default404Instance, D as DEFAULT_404_ROUTE, m as manifest } from './chunks/_@astrojs-manifest_S26lO2BN.mjs';
...
const _page1 = () => import('./pages/certificacion-ielts.astro.mjs');
const _page2 = () => import('./pages/cursos-de-ingles-general-extranjero.astro.mjs');
const _page3 = () => import('./pages/entrenamientovocacional.astro.mjs');
const _page4 = () => import('./pages/envioexitoso.astro.mjs');
const _page5 = () => import('./pages/estudiaenaustralia.astro.mjs');
const _page6 = () => import('./pages/estudiaencanada.astro.mjs');
const _page7 = () => import('./pages/estudiaeninglaterra.astro.mjs');
const _page8 = () => import('./pages/estudiaenirlanda.astro.mjs');
const _page9 = () => import('./pages/estudiaennuevazelanda.astro.mjs');
const _page10 = () => import('./pages/faq.astro.mjs');
const _page11 = () => import('./pages/maestrias-australia-ingles.astro.mjs');
const _page12 = () => import('./pages/maestrias-en-el-extranjero.astro.mjs');
const _page13 = () => import('./pages/preparacion-tesol-caracteristicas.astro.mjs');
const _page14 = () => import('./pages/preparacioncertificaciontoefl.astro.mjs');
const _page15 = () => import('./pages/sobrenosotros.astro.mjs');
const _page16 = () => import('./pages/index.astro.mjs');

const pageMap = new Map([
    ["node_modules/astro/dist/assets/endpoint/generic.js", _page0],
    ["src/pages/certificacion-ielts.astro", _page1],
    ["src/pages/cursos-de-ingles-general-extranjero.astro", _page2],
    ["src/pages/entrenamientovocacional.astro", _page3],
    ["src/pages/envioexitoso.astro", _page4],
    ["src/pages/estudiaenaustralia.astro", _page5],
    ["src/pages/estudiaencanada.astro", _page6],
    ["src/pages/estudiaeninglaterra.astro", _page7],
    ["src/pages/estudiaenirlanda.astro", _page8],
    ["src/pages/estudiaennuevazelanda.astro", _page9],
    ["src/pages/faq.astro", _page10],
    ["src/pages/maestrias-australia-ingles.astro", _page11],
    ["src/pages/maestrias-en-el-extranjero.astro", _page12],
    ["src/pages/preparacion-tesol-caracteristicas.astro", _page13],
    ["src/pages/preparacioncertificaciontoefl.astro", _page14],
    ["src/pages/sobrenosotros.astro", _page15],
...
const _args = {
    "middlewareSecret": "091dd062-2dab-4fae-8825-9ec7c92ec686",
